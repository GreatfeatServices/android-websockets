...
public class MainActivity extends AppCompatActivity {
    ...
    private void start() {
        Request request = new Request.Builder().url("ws://www.oneph.top/cable").build();
    ...
    private final class EchoWebSocketListener extends WebSocketListener {
        ...
        public void onFailure(WebSocket webSocket, Throwable t, Response response) {
            ...
            Log.d(MainActivity.this.getClass().getName(), webSocket.toString());
            Log.d(MainActivity.this.getClass().getName(), response.toString());
        }
    }
